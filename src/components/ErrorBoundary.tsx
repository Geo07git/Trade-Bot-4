        ...
        <div className="min-h-screen w-full bg-black text-zinc-100 flex items-center justify-center p-4 font-sans">
          <div className="max-w-md w-full bg-zinc-900 border border-rose-500/30 rounded-2xl p-6 shadow-2xl space-y-5">
            <div className="flex items-center gap-3 border-b border-white/10 pb-4">
              ...
              <div>
                <h1 className="text-lg font-bold text-white">Eroare Interfață AI.TRADE</h1>
            ...
            <div className="flex flex-col sm:flex-row gap-3 pt-2">
              ...
              <button
                ...
                className="flex-1 py-2.5 px-4 bg-zinc-800 hover:bg-zinc-700 text-rose-400 border border-rose-500/20 rounded-xl text-xs font-semibold flex items-center justify-center gap-2 transition-all cursor-pointer"
              >
                <Trash2 className="w-4 h-4" />
                <span>Resetare State Local</span>
              </button>
            </div>
          </div>
        </div>
